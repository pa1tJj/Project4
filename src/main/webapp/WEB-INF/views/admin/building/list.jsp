                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 ">
                                                ...
                                                <div class="col-xs-2">
                                                    <security:authorize access="hasRole('MANAGER')"> <%--chỉ có role MANAGER mới thấy được phần này--%>
...
<script>
    ...
    //hiển thị tòa nhà đã được giao cho nhân viên
    ...
    function assignment(data) {
        $.ajax({
            ...
            //dataType: 'json',
            success: function (response) {
                window.location.href = "<c:url value="/admin/building-list?message=giao-thanh-cong"/>";
            },
            error: function (response) {
    ...
    // thực hiện khi bấm nút tìm kiếm
    $('#btnSearchBuilding').click(function (e) {//gọi nút tìm kiếm với id = btnSearchBuilding và thực hiện thao tác click
        e.preventDefault();
        $('#listForm').submit();
    });
    ...
    function deleteBuildings(data) {
        $.ajax({
            ...
            success: function (respond) {
                window.location.href = "<c:url value="/admin/building-list?message=xoa-thanh-cong"/>";
            },
